...
public class ImageCache extends ImageMemoryCache {
    ...
    public ImageCache() {
        this(DEFAULT_MAX_SIZE, DEFAULT_THREAD_POOL_SIZE,
                ImageSDCardCache.DEFAULT_MAX_SIZE, DEFAULT_THREAD_POOL_SIZE);
    }
    ...
    public ImageCache(int primaryCacheMaxSize) {
        this(primaryCacheMaxSize, DEFAULT_THREAD_POOL_SIZE, ImageSDCardCache.DEFAULT_MAX_SIZE,
    ...
    public ImageCache(int primaryCacheMaxSize, int secondaryCacheMaxSize) {
        this(primaryCacheMaxSize, DEFAULT_THREAD_POOL_SIZE, secondaryCacheMaxSize,
                DEFAULT_THREAD_POOL_SIZE);
    }
